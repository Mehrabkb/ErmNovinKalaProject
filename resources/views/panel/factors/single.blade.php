    ...
    <section class="content">
        <div class="body_scroll">
            ...
            <div class="container-fluid printer-div" style="align-items: center" id="printer-div">
                <!-- Basic Table -->
                <div class="row text-dark bg-white clearfix py-1 align-items-center" style="align-items: center;" >
                <div class="row align-items-center">
                    <div class="col-3 col-lg-3 col-md-3 col-sm-3 text-center">
                        <img src="{{ asset('pictures/logo.png') }}" style="width: 50%;" class="w-100" alt="">
                    </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 border" >
                    <h4 class="text-dark py-3 text-center" style="background : #ccc; border : 1px solid #000;">مشخصات فروشنده</h4>
                    ...
                    <h4 class="text-dark py-3 text-center" style="background : #ccc; border: 1px solid #000;">مشخصات خریدار</h4>
                    <div class="row justify-content-center py-1">
                        <div class="col-lg-4 col-md-4 col-sm-4 text-center">
                            <span><strong>شماره تلفن :</strong></span>
